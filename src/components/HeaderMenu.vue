...
<template>
    <div class="h-20 bg-black flex justify-between px-28">
        <span>Solitaire</span>
        <div class="flex gap-5">
            ...
            <button @click="showConfirmDialog('restart')" class="text-white border-2 border-white rounded p-4 h-14 leading-3 my-auto">New Game</button>
        </div>
    </div>
</template>
